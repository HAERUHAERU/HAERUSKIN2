...
function graphColor(Job, Name) {
    if (localStorage.getItem('thema') == 1) {
        ...
        switch (Job) {
            ...
            case 'MNK': case 'PGL': case "PUG": case 'DRG': case 'LNC': case 'SAM': case 'BLM': case 'THM': case 'SMN': case 'ACN': case 'RDM': case 'BLU': case 'BRD': case 'ARC': case 'MCH': case 'NIN': case 'ROG': return '#813b3c'
            case 'LMB': return '#FFBB00'
            case 'CBO': return '#757575'
            default: return '#353535'
        }
